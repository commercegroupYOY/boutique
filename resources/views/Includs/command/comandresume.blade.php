        ...
        <div
            ...
            <div class="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                <div
                    ...
                    <p class="text-lg md:text-xl dark:text-white font-semibold leading-6 xl:leading-5 text-gray-800">votre
                        panier</p>
                    ...
                    <div
                        ...
                        <li class="collection-item">
                            ...
                            @include('Includs\command\partials\adresses', ['name' => 'facturation'])
                            <div class="row">
                                <div class="col s12">
                                    <a href="#" class="btn" style="width: 100%"><i
                                ...
                                <div class="col s12">
                                    <label>
                                        <input id="different" name="different" type="checkbox"
                                            @if ($addresses->count() === 1) disabled="disabled" @endif>
                                        <span>
                                            @if ($addresses->count() === 1)
                                                Vous n'avez qu'une adresse enregistrée, si vous voulez une adresse
                                                différente pour la livraison <a href="{{ route('adresses.create') }}">vous
                        ...
                        <li id="liLivraison" class="collection-item hide">
                            ...
                            @include('Includs.command.partials.addresses', ['name' => 'livraison'])
                        </li>
                        <li class="collection-item">
                        ...
                        <li class="collection-item">
                            ...
                            @if ($shop->card)
                                ...
                                <p style="margin-left: 40px" class="hide">
                                    Vous devrez renseigner un formulaire de paiement sur la page de confirmation de cette
                                    commande.
                                </p>
                            @endif
                            @if ($shop->mandat)
                                ...
                                <p style="margin-left: 40px" class="hide">
                                    Envoyez un bon de commande avec la mention "Bon pour accord". Votre commande sera
                                    expédiée dès réception de ce bon de commande. N'oubliez pas de préciser la référence de
                                    la commande dans votre bon.
                                </p>
                            @endif
                            @if ($shop->transfer)
                                <p>
                                ...
                                <p style="margin-left: 40px" class="hide">
                                    Il vous faudra transférer le montant de la commande sur notre compte bancaire. Vous
                                    recevrez votre confirmation de commande comprenant nos coordonnées bancaires et le
                                    numéro de commande. Les biens seront mis de côté 30 jours pour vous et nous traiterons
                                    votre commande dès la réception du paiement.
                                </p>
                            @endif
                            @if ($shop->check)
                                <p>
                                ...
                                <p style="margin-left: 40px" class="hide">
                                    Il vous faudra nous envoyer un chèque du montant de la commande. Vous recevrez votre
                                    confirmation de commande comprenant nos coordonnées bancaires et le numéro de commande.
                                    Les biens seront mis de côté 30 jours pour vous et nous traiterons votre commande dès la
                            ...
                            <div class="row">
                                <div class="col s12">
                                    <label>
                                        ...
                                        <span>J'ai lu <a href="#" target="_blank">les conditions générales de vente et
                                                les conditions d'annulation</a> et j'y adhère sans réserve. </span>
                                    </label>
                                </div>
                            </div>
                        </li>
                    ...
                    <div class="row">
                        <div class="col s12">
                            <button id="commande" type="submit" class="btn disabled" style="width: 100%">Commande avec
                                obligation de paiement</button>
                        </div>
                    </div>
                    </form>
                </div>
    ...
    <script>
        ...
        const getDetails = async () => {
            ...
            const response = await fetch('#', {
                ...
                body: JSON.stringify({
                    facturation: document.querySelector(
                        'input[type=radio][name=facturation]:checked').value,
                    livraison: document.querySelector('input[type=radio][name=livraison]:checked')
                        .value,
                    different: document.querySelector('#different').checked,
                    pick: document.querySelector('input[type=radio][name=expedition]:checked')
                        .value == 'retrait'
                })
            });
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelector('#ok').addEventListener('change', () => document.querySelector('#commande')
            ...
            document.querySelectorAll('input[type=radio][name=expedition]').forEach(input => {
                input.addEventListener('change', () => {
                    if (document.querySelector('input[type=radio][name=expedition][value=retrait]')
                        .checked) {
                    ...
                    if (document.querySelector(
                            'input[type=radio][name=expedition][value=colissimo]').checked) {
