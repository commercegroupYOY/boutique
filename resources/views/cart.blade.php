...
<form method="post" action="{{ route('commande.panier') }}">
  {{ csrf_field() }}
      ...
      <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
        <div class="flex flex-col rounded-lg bg-white sm:flex-row">
          ...
          <div class="flex w-full flex-col px-4 py-4">
            ...
            {{-- <input type="hidden" id="product" name="product" value="{{$product->name}}">
            <input type="hidden" id="product" name="product" value="{{$product->price}}"> --}}
