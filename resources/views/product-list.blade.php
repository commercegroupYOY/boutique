        ...
        <div @click.away="open = false" class="relative" x-data="{ open: false }">
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute w-full mt-2 origin-top-right rounded-md shadow-lg md:w-48">
              <div class=" bg-white  shadow dark-mode:bg-gray-800">
                <a class="block px-4 py-2 mt-2 font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-blue-600 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="/Liste_des_produits/console">Console</a>
                <a class="block px-4 py-2 mt-2 font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-blue-600 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="/Liste_des_produits/jeux-video">Jeux-vidéos</a>
                <a class="block px-4 py-2 mt-2 font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-blue-600 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="/Liste_des_produits/merchandising">Merchandising</a>
              </div>
            </div>
          </div>
